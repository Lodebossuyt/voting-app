<div>
    <div class="filter flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="other_filters" id="category" class="w-full rounded-xl px-4 py-2 border-none">
    ...
    <div class="ideas-container space-y-6 my-6">
        ...
        @empty
            <div class="mx-auto w-70 mt-12 flex ">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                </svg>
                <div class="text-gray-400 text-center font-bold mt-1">No ideas were found...</div>
            </div>
        @endforelse
    </div>
    {{--End Ideascontainer--}}
